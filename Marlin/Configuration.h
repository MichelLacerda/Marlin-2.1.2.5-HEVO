...
#define STRING_CONFIG_H_AUTHOR "(Michel Lacerda, Hevo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "H.E.V.O"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 49.31
  #define DEFAULT_bedKi 3.58
  #define DEFAULT_bedKd 452.30
 ...
 */
// CORREIA POLIA
// (micro_passo * (360 / 1.8º)) / (tr2 * dentes_polia)
// (64.0 *  200.0) / (2.0 * 20) = 320

// FUSO
// (micro_passo * (360 / 1.8º)) / passo do fuso
// (32 * 200) / 8 = 400
// M303 E0  S220 C10
// M303 E-1 S60  C10 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 93.93 }
